...
class Manufacturers extends \Opencart\System\Engine\Model {
	...
	public function indexManufacturer($manufacturerId, $sourceId, $store_id)
	{
		...
		$document = $this->model_extension_agentfy_module_agentfy_api->getDocument($sourceId, $manufacturerId, $store_id);
