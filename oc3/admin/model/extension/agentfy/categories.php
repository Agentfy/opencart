<?php
class ModelExtensionAgentfyCategories extends Model
{
	...
	public function indexCategory($categoryId, $sourceId, $store_id)
	{
		...
		$document = $this->model_extension_agentfy_api->getDocument($sourceId, $categoryId, $store_id);
		...
		$seo_url_data = $this->model_design_seo_url->getSeoUrlsByQuery('product_id=' . $categoryId);
